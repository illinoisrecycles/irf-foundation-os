-- =====================================================
-- MIGRATION 007: AI BOOKKEEPING ENGINE (FIXED)
-- =====================================================
...
-- =====================
-- RLS - Read Policies (org members)
-- =====================

CREATE POLICY "ledger_accounts_select" ON public.ledger_accounts
  FOR SELECT USING (public.is_org_member(organization_id));

CREATE POLICY "org_bookkeeping_settings_select" ON public.org_bookkeeping_settings
  FOR SELECT USING (public.is_org_member(organization_id));
...
CREATE POLICY "bank_transaction_matches_select" ON public.bank_transaction_matches
  FOR SELECT USING (public.is_org_member(organization_id));
...
-- FIXED: budget_lines needs to join to budgets to get org_id
...
CREATE POLICY "financial_insights_select" ON public.financial_insights
  FOR SELECT USING (public.is_org_member(organization_id));
...
-- =====================
-- RLS - Write Policies (finance roles)
-- =====================
...
CREATE POLICY "org_bookkeeping_settings_all" ON public.org_bookkeeping_settings
  FOR ALL USING (public.has_org_role(organization_id, ARRAY['owner','admin','staff','finance']))
  WITH CHECK (public.has_org_role(organization_id, ARRAY['owner','admin','staff','finance']));
...
CREATE POLICY "bank_transaction_matches_all" ON public.bank_transaction_matches
  FOR ALL USING (public.has_org_role(organization_id, ARRAY['owner','admin','staff','finance']))
  WITH CHECK (public.has_org_role(organization_id, ARRAY['owner','admin','staff','finance']));
...
CREATE POLICY "receipt_scans_all" ON public.receipt_scans
  FOR ALL USING (public.has_org_role(organization_id, ARRAY['owner','admin','staff','finance']))
  WITH CHECK (public.has_org_role(organization_id, ARRAY['owner','admin','staff','finance']));
...
-- FIXED: budget_lines write policy
CREATE POLICY "budget_lines_all" ON public.budget_lines
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM public.budgets b 
      WHERE b.id = budget_lines.budget_id 
      AND public.has_org_role(b.organization_id, ARRAY['owner','admin','staff','finance'])
    )
  )
  WITH CHECK (
    EXISTS (
...
CREATE POLICY "financial_insights_all" ON public.financial_insights
  FOR ALL USING (public.has_org_role(organization_id, ARRAY['owner','admin','staff','finance']))
  WITH CHECK (public.has_org_role(organization_id, ARRAY['owner','admin','staff','finance']));
...
CREATE POLICY "financial_periods_all" ON public.financial_periods
  FOR ALL USING (public.has_org_role(organization_id, ARRAY['owner','admin','staff','finance']))
  WITH CHECK (public.has_org_role(organization_id, ARRAY['owner','admin','staff','finance']));
